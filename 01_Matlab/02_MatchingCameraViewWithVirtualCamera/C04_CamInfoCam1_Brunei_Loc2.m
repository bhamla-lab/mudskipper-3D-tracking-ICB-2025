...
n = 17; % The index of the image you want to read (e.g., 5th image)
fileExtension = 'bmp'; % File extension to search for

Data_cam = 'camera_parameters_Cam1_Brunei_Loc2.mat';
...
cameraPosition = [1.00 -0.31 -0.319];  % Camera location in 3D space
cameraTarget = [2.050 0.2 -0.182]; % Point the camera is looking at y down
