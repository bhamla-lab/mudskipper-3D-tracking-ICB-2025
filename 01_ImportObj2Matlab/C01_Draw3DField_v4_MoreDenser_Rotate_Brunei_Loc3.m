...
objFilePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Brunei_Loc3\ObjFiles\12_23_2024.obj'; % Replace with your OBJ file path
textureImagePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Brunei_Loc3\ObjFiles\textures\color.jpg'; % Replace with your texture image path
polygonFilePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Brunei_Loc3\ObjFiles\polygon.xlsx'; % Excel file with polygon points

dataFile = 'D02_3DFieldData_Brunei_Loc3.mat';
...
P1 = [-0.900865875000000,0.755690500000000,0.442070625000000]; %input('Point 1: ');
P3 = [-0.790517000000000,0.878426500000000,0.0891025000000000]; %input('Point 2: ');
P2 = [-1.11935387500000,0.922597625000000,0.0689877500000000];%input('Point 3: ');
...
% end
% save('D05_Calibration_BRN_Loc3',"Cali_points");