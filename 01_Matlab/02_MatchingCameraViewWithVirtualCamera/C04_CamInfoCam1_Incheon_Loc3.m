...
cameraPosition = [0.534347857628504,-0.112858346010667,0.359246448313282];  % Camera location in 3D space
cameraTarget = [1.175212412277515,0.12,0.36]; % Point the camera is looking at y down
...
focalLengthX = 1300; %1250; %1351.4236; 
...
save('camera_parameters_Cam1_Incheon_Loc3.mat', 'cameraPosition', 'cameraTarget', 'cameraUpVector', 'imageWidth', 'imageHeight', ...
