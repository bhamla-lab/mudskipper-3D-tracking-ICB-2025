...
close all;
% Load 3D field data
load("D02_3DFieldData_Incheon_Loc2.mat");

% Read image
parentFolder = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Incheon_Loc2\Vd01'; % Change this to your parent folder path
...
cameraPosition = [-0.894, 1.056 ,0.556];  % Camera location in 3D space
cameraTarget = [-0.345,0.55,0.09]; % Point the camera is looking at y down
cameraUpVector = [0.22, 0, 1]; % Up direction for the camera
% [0.2, 0, 1];
...
save('camera_parameters_Cam1_Incheon_Loc2.mat', 'cameraPosition', 'cameraTarget', 'cameraUpVector', 'imageWidth', 'imageHeight', ...
