...
close all;
% Load 3D field data
load("D02_3DFieldData_Brunei_Loc2.mat");

% Read image
parentFolder = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Brunei_Loc2\Cropped_Loc2_0244_0250'; % Change this to your parent folder path
...
imagePoint2D = [1543; 842; 1]; % Homogeneous 2D point
...
cameraPosition = [1.300, -0.498 , -0.289];  % Camera location in 3D space
cameraTarget = [1.005, 0.454, -0.286];
...
% radialDistortion = [-0.07, -0.05];  % No radial distortion (from the provided data) %[-0.05, -0.05]
radialDistortion = [0,0];  % No radial distortion (from the provided data) %[-0.05, -0.05]
...
save('camera_parameters_Cam1.mat', 'cameraPosition', 'cameraTarget', 'cameraUpVector', 'imageWidth', 'imageHeight', ...
