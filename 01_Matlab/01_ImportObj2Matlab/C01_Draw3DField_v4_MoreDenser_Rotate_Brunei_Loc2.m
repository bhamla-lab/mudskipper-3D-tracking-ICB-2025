...
objFilePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Brunei_Loc2\ObjFiles\8_29_2024.obj'; % Replace with your OBJ file path
textureImagePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Brunei_Loc2\ObjFiles\textures\color.jpg'; % Replace with your texture image path
polygonFilePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Brunei_Loc2\ObjFiles\polygon.xlsx'; % Excel file with polygon points

dataFile = 'D02_3DFieldData_Brunei_Loc2.mat';
...
P1 = [-1.31428825000000,1.82840500000000,0.324518875000000]; %input('Point 1: ');
P3 = [-1.28027200000000,1.67240900000000,0.248290750000000]; %input('Point 2: ');
P2 = [-1.34389550000000,1.68517112500000,0.435535125000000];%input('Point 3: ');
