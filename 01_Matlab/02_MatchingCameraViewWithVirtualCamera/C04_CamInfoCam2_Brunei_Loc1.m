...
close all;
% Load 3D field data
load("D02_3DFieldData_Brunei_Loc1.mat");

% Read image
parentFolder = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Brunei_Loc1\Cropped_Loc1_0410_0412'; % Change this to your parent folder path
n = 100; % The index of the image you want to read (e.g., 5th image)
fileExtension = 'bmp'; % File extension to search for

Data_cam = 'camera_parameters_Cam2_Brunei_Loc1.mat';
...
cameraPosition = [0.484096227662235,0.041673635194581,0.094881556572026];  % Camera location in 3D space
cameraTarget = [-0.265193665402209,-0.048540198346546,-0.103437645629089]; % Point the camera is looking at y down
