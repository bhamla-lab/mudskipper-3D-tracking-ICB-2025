...
n = 30; % The index of the image you want to read (e.g., 5th image)
fileExtension = 'bmp'; % File extension to search for

Data_cam = 'D05_camera_parameters_Cam2_Brunei_Loc3.mat';
...
cameraPosition = [1.351 -1.227 -0.847];  % Camera location in 3D space
cameraTarget = [-0.4 -0.82 -1.1]; % Point the camera is looking at y down
cameraUpVector = [0.2, 0, 1]; % Up direction for the camera
% [0.2, 0, 1];
