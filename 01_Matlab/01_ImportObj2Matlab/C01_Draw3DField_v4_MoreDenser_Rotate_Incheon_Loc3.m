...
objFilePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Incheon_Loc3\ObjFiles\8_24_2024.obj'; % Replace with your OBJ file path
textureImagePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Incheon_Loc3\ObjFiles\textures\color.jpg'; % Replace with your texture image path
polygonFilePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Incheon_Loc3\ObjFiles\polygon.xlsx'; % Excel file with polygon points

dataFile = 'D02_3DFieldData_Incheon_Loc3.mat';
dataWater = 'D03_WaterEdge_Incheon_Loc3.mat';
subdivisionLevel = 4; % Increase for finer subdivisions
...
P1 = [-1.17425312500000,0.262875500000000,-0.258798875000000]; %input('Point 1: ');
P2 = [-1.12670925000000,0.224747625000000,-0.0499485000000000]; %input('Point 2: ');
P3 = [-0.902809125000000,0.211200875000000,-0.116713375000000];%input('Point 3: ');
...
hold on;
fill3(projected_points(:, 1), projected_points(:, 2), projected_points(:, 3), 'cyan', 'FaceAlpha', 0.5, 'EdgeColor', 'none'); hold on;
save(dataWater, 'projected_points','normal','center');
...
% end
% save('D05_Calibration_Loc3',"Cali_points");