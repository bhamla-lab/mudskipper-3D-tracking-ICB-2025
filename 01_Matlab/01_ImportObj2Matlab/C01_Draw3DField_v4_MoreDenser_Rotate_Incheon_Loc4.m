...
objFilePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Incheon_Loc4\ObjFiles\12_23_2024.obj'; % Replace with your OBJ file path
textureImagePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Incheon_Loc4\ObjFiles\textures\color.jpg'; % Replace with your texture image path
polygonFilePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Incheon_Loc4\ObjFiles\polygon.xlsx'; % Excel file with polygon points

dataFile = 'D02_3DFieldData_Incheon_Loc4.mat';
...
P1 = [-1.24203537500000,0.0730826250000000,0.396222750000000]; %input('Point 1: ');
P3 = [-1.03639050000000,0.0650035000000000,0.404491000000000]; %input('Point 2: ');
P2 = [-1.13694875000000,0.0647705000000000,0.556253750000000];%input('Point 3: ');
