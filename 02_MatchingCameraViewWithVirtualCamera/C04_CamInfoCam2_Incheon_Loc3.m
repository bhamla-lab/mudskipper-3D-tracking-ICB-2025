...
close all;
% Load 3D field data
load("D02_3DFieldData_Incheon_Loc3.mat");

% Read image
parentFolder = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Incheon_Loc3\Vd01'; % Change this to your parent folder path
n = 70; % The index of the image you want to read (e.g., 5th image)
...
cameraPosition = [1.079170973197629, -0.429990652907744, 0.386491115283737];  % Camera location in 3D space
cameraTarget = [0.981451438448666, -0.15, 0.36]; % Point the camera is looking at y down
...
focalLengthX = 1250; %1250; %1351.4236; 
...
save('camera_parameters_Cam2_Incheon_Loc3.mat', 'cameraPosition', 'cameraTarget', 'cameraUpVector', 'imageWidth', 'imageHeight', ...
