...
objFilePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Brunei_Loc1\ObjFiles\8_29_2024.obj'; % Replace with your OBJ file path
textureImagePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Brunei_Loc1\ObjFiles\textures\color.jpg'; % Replace with your texture image path
polygonFilePath = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Brunei_Loc1\ObjFiles\polygon.xlsx'; % Excel file with polygon points

dataFile = 'D02_3DFieldData_Brunei_Loc1.mat'; % Change the region and location number
...
P1 = [-0.188811000000000,0.00256037500000000,0.0423146250000000]; %input('Point 1: ');
P3 = [-0.00579187500000000,-9.75000000000021e-05,0.0148973750000000]; %input('Point 2: ');
P2 = [-0.119274750000000,-0.00230312500000000,0.288433625000000];%input('Point 3: ');
