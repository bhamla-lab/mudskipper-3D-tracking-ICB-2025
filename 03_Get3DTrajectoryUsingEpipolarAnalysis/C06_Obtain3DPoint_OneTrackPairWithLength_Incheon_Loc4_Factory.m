...
Track_foler = 'G:\My Drive\Work\_GIT (2023~)\01 Mudskipper\20241216 3DTrackVideoCases\01_Videos\Incheon_Loc4';

matFiles = dir(fullfile(Track_foler,'Cropped_Loc4_*.tsv'));
...
% Load 3D field data
load("D02_3DFieldData_Incheon_Loc4.mat");
load("D03_WaterEdge_Incheon_Loc4.mat");
Caminfo1=load('D01_camera_parameters_Cam1_Incheon_Loc4.mat');
Caminfo2=load('D01_camera_parameters_Cam2_Incheon_Loc4.mat');
...
Track_save = ['D04_Track3DPoints_INC_',Track_read(9:end-9),'.mat'];
